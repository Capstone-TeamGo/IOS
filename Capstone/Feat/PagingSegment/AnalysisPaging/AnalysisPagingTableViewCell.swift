//
//  AnalysisPagingTableViewCell.swift
//  Capstone
//
...
class AnalysisPagingTableViewCell: UITableViewCell {
    static let id : String = "AnalysisPagingTableViewCell"
    //MARK: - UI Components
...
//MARK: - UI Layout
private extension AnalysisPagingTableViewCell {
...
//MARK: - UI Configure
extension AnalysisPagingTableViewCell {
    public func configure(model : AnaylsisResponseDtoList) {
        self.titleLabel.text = model.time
        if let score = model.feelingState {
